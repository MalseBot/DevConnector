...
"[project]/client/app/store/slices/postSlice.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const initialState = __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$app$2f$store$2f$types$2f$post$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialPostState"];
const getPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('posts/getPosts', async (_, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/posts');
        return response.data;
    } catch (error) {
        return rejectWithValue((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$errorHandler$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getErrorMessage"])(error));
    }
});
const getPostById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('posts/getPostById', async (postId, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/posts/${postId}`);
        return response.data;
    } catch (error) {
        return rejectWithValue((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$errorHandler$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getErrorMessage"])(error));
    }
});
const createPost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('posts/createPost', async (text, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/posts', {
            text
        });
        return response.data;
    } catch (error) {
...
const deletePost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('posts/deletePost', async (postId, { rejectWithValue })=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/posts/${postId}`);
        return postId;
    } catch (error) {
        return rejectWithValue((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$errorHandler$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getErrorMessage"])(error));
    }
});
const likePost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('posts/likePost', async (postId, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/posts/like/${postId}`);
        return response.data;
    } catch (error) {
        return rejectWithValue((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$errorHandler$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getErrorMessage"])(error));
    }
});
const unlikePost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('posts/unlikePost', async (postId, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/posts/unlike/${postId}`);
        return response.data;
    } catch (error) {
        console.log((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$errorHandler$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getErrorMessage"])(error));
        return rejectWithValue((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$errorHandler$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getErrorMessage"])(error));
    }
});
const addComment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('posts/addComment', async ({ postId, text }, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/posts/comment/${postId}`, {
            text
        });
        return response.data;
    } catch (error) {
...
const deleteComment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('posts/deleteComment', async ({ postId, commentId }, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/posts/comment/${postId}/${commentId}`);
        return response.data;
    } catch (error) {
        return rejectWithValue((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$errorHandler$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getErrorMessage"])(error));
    }
});
const postSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    name: 'posts',
    initialState,
    reducers: {
        clearPost: (state)=>{
...
const store = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["configureStore"])({
    reducer: {
        ...
        posts: __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$app$2f$store$2f$slices$2f$postSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
    }
});
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__79f8e9bc._.js.map