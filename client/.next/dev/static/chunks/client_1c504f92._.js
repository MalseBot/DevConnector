...
const getAllProfiles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('profile/getAllProfiles', async (_, { rejectWithValue })=>{
    try {
        ...
        return rejectWithValue(getErrorMessage(error) || 'Failed to fetch profiles');
    }
});
...
const validateToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('login/validateToken', async (token, { rejectWithValue })=>{
    try {
...
const useAuth = ()=>{
    ...
    const handleRegister = async (userData)=>{
        try {
            const result1 = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$app$2f$store$2f$slices$2f$registerSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerUser"])(userData)).unwrap();
    ...
    const handleLogin = async (credentials)=>{
        try {
            ...
            await dispatch(getCurrentProfile(res.user)).unwrap();
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$app$2f$store$2f$slices$2f$alertSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAlert"])({
                id: `${Date.now()}`,
                type: 'success',
    ...
    const handleDeleteUser = async ()=>{
        try {
            const result1 = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$app$2f$store$2f$slices$2f$loginSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteUser"])()).unwrap();
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$app$2f$store$2f$slices$2f$alertSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAlert"])({
                id: `${Date.now()}`,
                type: 'success',
...
_s(useAuth, "BtvN+H0UsI8JpHtORSBdsYDABmI=", true, function() {
    return [
...
function AuthInitializer() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthInitializer.useEffect": ()=>{
            ...
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$app$2f$store$2f$slices$2f$loginSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateToken"])(token));
        }
    }["AuthInitializer.useEffect"], [
        dispatch
    ]);
...
//# sourceMappingURL=client_1c504f92._.js.map